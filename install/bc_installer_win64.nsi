...
!ifndef OUTPUTFILE
!define OUTPUTFILE "Setup-BridgeCommand-SOMOS-2.6.exe"
!endif
!define INSTALLLOCATION "Bridge Command SOMOS 2.6"
!define SMFOLDER "Bridge Command SOMOS 2.6"
!define REGKEY "BridgeCommandSOMOS2.5"
