...
void ScenarioChoice::chooseScenario(std::string& scenarioName, OperatingMode::Mode& mode, std::string scenarioPath, float fontScale, std::string enetSrvAddr, irr::u32 enetSrvPort)
{
    ...
    StartupEventReceiver startupReceiver(scenarioListBox,instruction,secondaryCheckbox,multiplayerCheckbox,description,GUI_ID_SCENARIO_LISTBOX,GUI_ID_OK_BUTTON,GUI_ID_SECONDARY_CHECKBOX,GUI_ID_MULTIPLAYER_CHECKBOX,GUI_ID_EXIT_BUTTON, device, enetSrvAddr, enetSrvPort);
